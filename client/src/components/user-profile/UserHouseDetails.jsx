    ...
    <div className='houseDetails-container'>
        ...
        <div className="main">
            <div className='house-details'>
                ...
                {houseFormError && <ResponseMessage backgroundColor='#ffcccc' color='red' message='Age is required!'/>}
                {!houseFormError && spinner.active && <div style={{display: 'flex', alignItems: 'center'}}><p style={{fontSize: '20px', fontWeight: '600', marginRight: '20px'}}>{spinner.message}</p><img style={{width: '50px', height: '50px'}} src={Loading} alt=''/></div>}
                <form onSubmit={updateHouseData} className='other-house-info'>
                    <div className="left-side">
                        <div className='input-label-container'>
                            <label htmlFor='uploadphoto'>Upload/Change photo: </label>
                            <input type="file" name="photo" value={file} onChange={handleFile} id="uploadphoto" />
                        </div>
                        <div className='input-label-container'>
                ...
                <div className="other-relevant-info">
                    ...
                    <div className="input-label-container">
                        ...
                        <p className='data'>{houseData.joinRequests}</p>
                    </div>
                </div>
                ...
                <form onSubmit={updateRequirementsData} className='form-data'>
                    ...
                    <fieldset>
                        ...
                        <label htmlFor="male">Male &nbsp;&nbsp;
                            <input type="radio" name="Male" id="male" value='Male' onChange={handleJoinRequirementInfo} checked={joinRequirements.gender==='Male' ? true : false}/>
                        </label>
                        <label htmlFor="female">Female &nbsp;&nbsp;
                            <input type="radio" name="Female" id="female" value='Female' onChange={handleJoinRequirementInfo} checked={joinRequirements.gender==='Female' ? true : false}/>
                        </label>
                        <label htmlFor="other">Other &nbsp;&nbsp;
                            <input type="radio" name="Other" id="other" value='Other' onChange={handleJoinRequirementInfo} checked={joinRequirements.gender==='Other' ? true : false}/>
                        </label>
                    </fieldset>
                    <fieldset>
