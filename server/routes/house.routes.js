...
const { list, testing, save, update, removeHouse, findByStatus, findByLocation, findByTenant, broadSearch, findByVerified, findByEmail } = require('../controllers/house.controller');
